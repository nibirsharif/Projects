...
namespace LaunchServiceBD
{
    public partial class Page19 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map19" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাহেরচরবাজার", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৮টা\nদুপুর-২টা\nবিকাল-৫.৩০মিনিট\nসন্ধ্যা-৬টা\nসন্ধ্যা-৭টা\nরাত-৯.৩০মিনিট\nরাত-১০.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বাহেরচরবাজার থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সকাল-৮টা\nসকাল-৯টা\nসকাল-৯.৩০মিনিট\nদুপুর-১২টা\nসন্ধ্যা-৭.৩০মিনিট\nরাত-৯.৪৫মিনিট\nরাত-১০.১৫মিনিট\nরাত-১১টা\nরাত-১টা" });
