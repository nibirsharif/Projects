...
{
    public partial class Page85 : PhoneApplicationPage
    {
        public Page85()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - ভাষানচর", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = " ঢাকা থেকে ছাড়ে রাত ০৯.৩০ টা ভাষানচর পৌঁছে সকাল ০৮.০০ টা।ভাষানচর থেকে ছাড়ে সন্ধ্যা ০৫.৩০ টা ঢাকা পৌঁছে ভোর ০৫.৩০ টা।", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮-০১৭১৯-৫৯৪৮০৯ " });

            launchtList.Add(new Launch() { Name = "ঢাকা – ভাষানচর", Route = "ডাবল কেবিন - ১২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ভাষানচর", Route = "সিঙ্গেল কেবিন - ৬০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ভাষানচর", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ভাষানচর", Route = "ভিআইপি কেবিন - ১৪০০/-", Fare = "" });
