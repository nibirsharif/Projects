...
{
    public partial class Page44 : PhoneApplicationPage
    {
        public Page44()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map44" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বোরহানউদ্দিন", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৭.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বোরহানউদ্দিন থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-২.৪৫মিনিট" });
