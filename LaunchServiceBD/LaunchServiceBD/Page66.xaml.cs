...
{
    public partial class Page66 : PhoneApplicationPage
    {
        public Page66()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – বরগুনা", Fare = "এই লঞ্চটি ঢাকার সদরঘাট টার্মিনাল থেকে সন্ধ্যা ৫.৩০ মিনিটে গলাচিপার উদ্দেশ্যে ছেড়ে যায়।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে সরাসরি যোগাযোগ করা যায়।", Fare = "মোবাইল: ০১৭২৭-৬৬৯৯৬০" });


            launchtList.Add(new Launch() { Name = "ঢাকা – বরগুনা", Route = "ভিআইপি - ২,৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বরগুনা", Route = "ডাবল কেবিন - ১,৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বরগুনা", Route = "সিঙ্গেল কেবিন - ৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বরগুনা", Route = "৩য় শ্রেণী (ডেক) - ২২০/-", Fare = "" });
