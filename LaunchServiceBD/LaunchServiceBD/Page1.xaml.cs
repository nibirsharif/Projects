...
namespace LaunchServiceBD
{
    public partial class Page1 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map1" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাগেরহাট", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৯.৪৫মিনিট" });
            launchtList.Add(new Launch() { Name = "বাগেরহাট থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সন্ধ্যা-৬.৪৫মিনিট" });
