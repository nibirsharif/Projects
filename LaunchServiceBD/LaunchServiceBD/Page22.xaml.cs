...
namespace LaunchServiceBD
{
    public partial class Page22 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map22" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাঙ্গিরচর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "বিকাল-৫.৩০মিনিট\nসন্ধ্যা-৭.৩০মিনিট\nরাত-৮.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বাঙ্গিরচর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সন্ধ্যা-৭টা\nরাত-৭.৪৫মিনিট\nরাত-৮টা" });
