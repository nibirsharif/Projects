...
{
    public partial class Page49 : PhoneApplicationPage
    {
        public Page49()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map49" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাদলপাড়া", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৮.১৫মিনিট" });
            launchtList.Add(new Launch() { Name = "বাদলপাড়া থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "রাত-৮.১০মিনিট" });
