...
{
    public partial class Page86 : PhoneApplicationPage
    {
        public Page86()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা – চাঁদপুর – ইচলী", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = " লঞ্চটি মাঝখানে ১ দিন বিরতি দিয়ে ঢাকা থেকে চাঁদপুর ও ইচালীর উদ্দেশ্যে ছেড়ে যায় রাত ১২ টায়, ইচলী থেকে বেলা ১১ টা এবং চাঁদপুর থেকে দুপুর ১২ টায় ঢাকার উদ্দেশ্যে ছেড়ে আসে।", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = "মোবাইল নম্বর:+৮৮-০১৭৬৫-৪৩০৪৯০" });

            launchtList.Add(new Launch() { Name = "ঢাকা – চাঁদপুর", Route = "ডাবল কেবিন - ৬০০ টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – চাঁদপুর", Route = "সিঙ্গেল কেবিন - ৩০০ টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – চাঁদপুর", Route = "এসি ডাবল কেবিন - ৭০০ টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – চাঁদপুর", Route = "ভিআইপি কেবিন - ১,৫০০ টাকা", Fare = "" });
