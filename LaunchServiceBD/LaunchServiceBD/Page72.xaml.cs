...
{
    public partial class Page72 : PhoneApplicationPage
    {
        public Page72()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            //এম ভি টিপু-৫
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - হাতিয়া", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-হাতিয়া", Fare = "সন্ধ্যা ০৫.৩০ মিনিটে ঢাকার সদরঘাট থেকে লঞ্চটি হাতিয়ার উদ্দেশ্যে ছেড়ে যায়। সকাল ০৮.০০ টায় হাতিয়া পৌঁছে যায়। হাতিয়া থেকে দুপুর ১২.৩০ টায় ঢাকার সদরঘাটের উদ্দেশ্যে ছেড়ে আসে এবং সকাল ০৫.৩০ টা থেকে ০৬.০০ টার মধ্যে ঢাকা পৌঁছে।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "যে কোন তথ্যের জন্য সদরঘাট লঞ্চ টার্মিনালে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮-০১৭১১-৩৪৮৮১৩" });


            launchtList.Add(new Launch() { Name = "ঢাকা - হাতিয়া", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - হাতিয়া", Route = "সিংগেল কেবিন - ৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - হাতিয়া", Route = "ডাবল কেবিন - ১৫০০/-", Fare = "" });
