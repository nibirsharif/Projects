...
namespace LaunchServiceBD
{
    public partial class Page16 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map16" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চৌখালী", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "বিকাল-৬টা" });
            launchtList.Add(new Launch() { Name = "চৌখালী থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৫.৪৫মিনিট" });
