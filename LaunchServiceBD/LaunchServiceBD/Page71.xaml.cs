...
{
    public partial class Page71 : PhoneApplicationPage
    {
        public Page71()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-চরফ্যাশন", Fare = "সন্ধ্যা ০৬.৪৫ মিনিটে ঢাকার সদরঘাট থেকে লঞ্চটি চরফ্যাশনের উদ্দেশ্যে ছেড়ে যায়। সকাল ০৬.০০ টায় চরফ্যাশনে পৌঁছে যায়। চরফ্যাশন থেকে বিকাল ০৪.০০টায় ঢাকার সদরঘাটের উদ্দেশ্যে ছেড়ে আসে এবং সকাল ০৬.০০ টায়  ঢাকা পৌঁছে।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "যে কোন তথ্যের জন্য সদরঘাট লঞ্চ টার্মিনালে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮-০১৭১২-৫৬১২৩৪" });


            launchtList.Add(new Launch() { Name = "ঢাকা - চরফ্যাশন", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - চরফ্যাশন", Route = "সিংগেল কেবিন - ৭০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - চরফ্যাশন", Route = "ডাবল কেবিন - ১৩০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - চরফ্যাশন", Route = "ভিআইপি কেবিন - ২০০০/-", Fare = "" });
