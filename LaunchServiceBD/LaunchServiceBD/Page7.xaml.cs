...
namespace LaunchServiceBD
{
    public partial class Page7 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map7" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চরবোরহান", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "সন্ধ্যা-৭টা\nরাত-৮টা\nরাত-৯.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "চরবোরহান থেকে সদরঘাট,ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-২.০৫মিনিট\nবিকাল-৩.০৫মিনিট" });
