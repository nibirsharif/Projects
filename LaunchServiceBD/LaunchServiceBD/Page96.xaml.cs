...
{
    public partial class Page96 : PhoneApplicationPage
    {
        public Page96()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - গলাচিপা (পটুয়াখালী) ", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা সন্ধ্যা ০৫.৩০ টা গলাচিপা পৌঁছে সকাল ০৭.০০ টা।গলাচিপা (পটুয়াখালী)  থেকে ঢাকার উদ্দেশ্যে ছাড়ে দুপুর ০১.০০ টা ঢাকা পৌঁছে সকাল ০৭.০০/০৭.৩০ টা", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = " যোগাযোগের ফোন নম্বর: +৮৮-০১৭২৫২৬৯০২১" });

            launchtList.Add(new Launch() { Name = "ঢাকা - গলাচিপা (পটুয়াখালী)", Route = "ডাবল কেবিন - ১৮০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - গলাচিপা (পটুয়াখালী)", Route = "সিঙ্গেল কেবিন - ১০০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - গলাচিপা (পটুয়াখালী)", Route = "ডেক - ২০০/- টাকা", Fare = "" });
