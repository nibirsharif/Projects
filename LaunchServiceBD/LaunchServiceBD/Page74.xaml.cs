...
{
    public partial class Page74 : PhoneApplicationPage
    {
        public Page74()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – পটুয়াখালী", Fare = "এই লঞ্চটি ঢাকার সদরঘাট টার্মিনাল থেকে বিকাল ৫.৪৫ মিনিটে পটুয়াখালীর উদ্দেশ্যে ছেড়ে যায়।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে সরাসরি যোগাযোগ করা যায়।", Fare = "মোবাইল:+৮৮- ০১৭১২-০২৩১০০  " });
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা – পটুয়াখালী", Route = "ডেক - ২০০/-", Fare = "" });
