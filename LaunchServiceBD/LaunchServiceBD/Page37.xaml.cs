...
{
    public partial class Page37 : PhoneApplicationPage
    {
        public Page37()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map37" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বগা", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-২.৩০মিনিট\nবিকাল-৩টা\nসন্ধ্যা-৬টা\nসন্ধ্যা-৬.৩০মিনিট\nসন্ধ্যা-৭.০৫মিনিট" });
            launchtList.Add(new Launch() { Name = "বগা থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৪.১০মিনিট\nসন্ধ্যা-৬টা\nসন্ধ্যা-৭.১৫\nমিনিটরাত-৭.৩০মিনিট" });
