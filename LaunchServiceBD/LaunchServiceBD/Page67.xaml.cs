...
{
    public partial class Page67 : PhoneApplicationPage
    {
        public Page67()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            //এম ভি টিপু
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা – ঝালকাঠি", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – ঝালকাঠি", Fare = "ঢাকা  থেকে ছাড়ে সন্ধ্যা ০৭.৩০ টা পৌঁছে সকাল ০৬.০০/৬.৩০ টা| ঝালকাঠি থেকে  ছাড়ে সন্ধ্যা ০৬.০০ টা পৌঁছে সকাল ০৬.০০/৬.৩০ টা|" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "যে কোন তথ্যের জন্য সদরঘাট লঞ্চ টার্মিনালে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮০-১৭২১৯৭৮৬৫২" });


            launchtList.Add(new Launch() { Name = "ঢাকা – ঝালকাঠি", Route = "তৃতীয় শ্রেণী (ডেক) - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ঝালকাঠি", Route = "সিংগেল কেবিন - ৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ঝালকাঠি", Route = "ডাবল কেবিন - ১৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ঝালকাঠি", Route = "ফ্যামিলি কেবিন - ১৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ঝালকাঠি", Route = "ভিআইপি কেবিন - ২৫০০/-", Fare = "" });
