...
{
    public partial class Page70 : PhoneApplicationPage
    {
        public Page70()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            //এম. ভি টিপু - ২
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা – দৌলতখান", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – দৌলতখান", Fare = "সদরঘাট থেকে ছাড়ার সময় সন্ধ্যা ৬.৩০ টা পৌঁছে সকাল ৬ টা| দৌলতখান থেকে ছাড়ার সময় বিকাল ৩ টা পৌঁছে ভোর ৫ টা |" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "ঢাকার সদরঘাট লঞ্চ টার্মিনালে সরাসরি যোগাযোগ করা যায়।", Fare = "মোবাইল: +৮৮-০১৭১৬-২৪১৬৮৮" });


            launchtList.Add(new Launch() { Name = "ঢাকা – দৌলতখান", Route = "ভিআইপি - ২,৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – দৌলতখান", Route = "ডাবল কেবিন - ১৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – দৌলতখান", Route = "সিঙ্গেল কেবিন - ১০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – দৌলতখান", Route = "ডেক - ২০০/-", Fare = "" });
