...
{
    public partial class Page46 : PhoneApplicationPage
    {
        public Page46()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map46" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বোয়ালিয়া", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "বিকাল-৫.৩০মিনিট\nবিকাল-৬টা" });
            launchtList.Add(new Launch() { Name = "বোয়ালিয়া থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সন্ধ্যা-৭টা\nরাত-৮.৫৫মিনিট" });
            return launchtList;
        }
