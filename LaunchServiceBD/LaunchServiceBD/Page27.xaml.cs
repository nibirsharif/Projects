...
namespace LaunchServiceBD
{
    public partial class Page27 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map27" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাদশানগর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-২.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বাদশানগর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সন্ধ্যা-৬.৪০মিনিট" });
            return launchtList;
        }
