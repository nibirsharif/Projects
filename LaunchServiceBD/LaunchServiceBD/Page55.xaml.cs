...
{
    public partial class Page55 : PhoneApplicationPage
    {
        public Page55()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-বরিশাল", Fare = "ঢাকা থেকে ছাড়ার সময় রাত ০৮.৪৫ , ভোর ০৫.০০ টার মধ্যে বরিশাল পৌঁছে যায়। বরিশাল থেকে রাত ০৮.৪৫ সদরঘাটের উদ্দেশ্যে ছেড়ে আসে এবং ভোর ০৪.০০ টা থেকে ভোর ০৫.০০ টার মধ্যে ঢাকা পৌঁছে থাকে।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "তথ্যের জন্য সদরঘাট লঞ্চ টার্মিনালে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮-০১৭১৮-৪৫৩৯৮৯।" });


            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভি.আই.পি -১ - ৪০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভি.আই.পি-২ - ৪০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভি.আই.পি-৩ - ৪০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভি.আই.পি-৪ - ৩০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "সেমি-ভি.আই.পি - ২৬০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ডাবল কেবিন - ১৬০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "সিংঙ্গেল কেবিন - ৮৫০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ফ্যামিলি কেবিন - ১৭০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "সোভা কেবিন - ৫০০/-", Fare = "" });
