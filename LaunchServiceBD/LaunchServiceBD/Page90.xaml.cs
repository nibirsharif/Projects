...
{
    public partial class Page90 : PhoneApplicationPage
    {
        public Page90()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            //এম ভি স্বর্নদ্বীপ প্লাস

            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - কালাইয়া", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা ০৬.০০ টা কালাইয়া পৌঁছে সকাল ০৬.০০/৭.০০ টা। কালাইয়া থেকে ঢাকার উদ্দেশ্যে ছাড়ে বিকাল ০৩.০০ টা ঢাকা পৌঁছে সকাল ০৫.০০/৬.০০ টা।", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = " যোগাযোগের ফোন নম্বর: +৮৮-০১১৯০৩৭৯১৪৬" });

            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "ডাবল কেবিন - ১৮০০/- টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "সিঙ্গেল কেবিন - ১০০০/- টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "কেবিন (ভিআইপি) - ৩৫০০/- টাকা", Fare = "" });
