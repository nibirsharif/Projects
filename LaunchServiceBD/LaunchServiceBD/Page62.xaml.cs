...
{
    public partial class Page62 : PhoneApplicationPage
    {
        public Page62()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-বরিশাল", Fare = "রাত ৮:৪০ মিনিটে ঢাকার সদরঘাট থেকে লঞ্চটি বরিশালের উদ্দেশ্যে ছেড়ে যায়। ঢাকা থেকে বরিশাল যাওয়া আসার সময় দীর্ঘ হওয়ার কারণে প্রতি তিন দিনে একটি যাত্রা সম্পন্ন করে থাকে লঞ্চটি।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট অফিস বা বরিশাল অফিসে যোগাযোগ করা যেতে পারে যেকোন তথ্যের জন্য।", Fare = "ফোন নম্বর: +৮৮-০১৭১১-৩৩০৬৪২।" });
