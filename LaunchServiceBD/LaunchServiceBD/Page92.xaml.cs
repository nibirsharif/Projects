...
{
    public partial class Page92 : PhoneApplicationPage
    {
        public Page92()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা ০৫.৩০ টা বরগুনা  পৌঁছে বেলা ১১.০০ টা। বরগুনা  থেকে ঢাকার উদ্দেশ্যে ছাড়ে দুপুর ০১.৩০ টা ঢাকা পৌঁছে  বেলা ১১.০০ টা", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = " যোগাযোগের ফোন নম্বর: +৮৮-০১৭৩১৭৯৪৭৫০" });

            launchtList.Add(new Launch() { Name = "ঢাকা - বরগুনা", Route = "ডাবল কেবিন - ২০০০/- টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরগুনা", Route = "সিঙ্গেল কেবিন - ১০০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরগুনা", Route = "ডেক - ৩০০/- টাকা", Fare = "" });
