...
{
    public partial class Page45 : PhoneApplicationPage
    {
        public Page45()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map45" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বিশ্বাসেরহাট", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-২টা\nবিকাল-৪টা\nবিকাল-৬.১৫মিনিট" });
            launchtList.Add(new Launch() { Name = "বিশ্বাসেরহাট থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৫.৩০মিনিট\nসন্ধ্যা-৬টা\nসন্ধ্যা-৬.৪৫মিনিট" });
