...
namespace LaunchServiceBD
{
    public partial class Page13 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map13" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চাঁদপুর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-১২টা\nদুপুর-১২.৪৫মিনিট\nবিকাল-৪.৩০মিনিট\nবিকাল-৫টা\nসন্ধ্যা-৬টা\nসন্ধ্যা-৬.১৫মিনিট\nরাত-৭.৫০মিনিট\nরাত-৮.০৫মিনিট\nরাত-৮.৪৫মিনিট\nরাত-৯.১৫মিনিট\nরাত-৯.৪৫মিনিট\nরাত-১১.৩০মিনিট\nরাত-১.৩০মিনিট\nভোর-৪.২০মিনিট" });
            launchtList.Add(new Launch() { Name = "চাঁদপুর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সকাল-১১টা\nদুপুর-২টা\nবিকাল-৩.০৫মিনিট\nবিকাল-৩.৪৫মিনিট\nরাত-১০.৩০মিনিট\nরাত-১১টা\nরাত-১১.৩০মিনিট\nরাত-১১.৪৫মিনিট\nরাত-১২.০৫মিনিট\nরাত-১২.৩০মিনিট\nরাত-২.৩০মিনিট\nরাত-৩.১৫মিনিট" });
