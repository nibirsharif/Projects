...
{
    public partial class Page38 : PhoneApplicationPage
    {
        public Page38()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map38" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাগদা", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "বিকাল-৬.১৫	মিনিট" });
            launchtList.Add(new Launch() { Name = "বাগদা থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-২.১৫মিনিট" });
            launchtList.Add(new Launch() { Name = "যাতায়াতকারী লঞ্চ", Route = "রকেট সার্ভিস", Fare = "" });
            launchtList.Add(new Launch() { Name = "যাতায়াতকারী লঞ্চ", Route = "এম ভি মানিক–৮", Fare = "" });
            launchtList.Add(new Launch() { Name = "যাতায়াতকারী লঞ্চ", Route = "এম ভি সেলা", Fare = "" });
            return launchtList;
        }
        ...
        private void LLS_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            try
            {
                ...
                else if (data.Route == "এম ভি মানিক–৮")
                {
                    string go = "/" + "Page84" + ".xaml";
                    NavigationService.Navigate(new Uri(go, UriKind.Relative));
                }
                else if (data.Route == "এম ভি সেলা")
                {
                    string go = "/" + "Page97" + ".xaml";
                    NavigationService.Navigate(new Uri(go, UriKind.Relative));
                }
            }
            catch (NullReferenceException) { }
