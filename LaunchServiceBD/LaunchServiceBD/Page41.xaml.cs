...
{
    public partial class Page41 : PhoneApplicationPage
    {
        public Page41()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map41" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বদরপুর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৮.০৫মিনিট\nরাত-৮.৪৫মিনিট" });
            launchtList.Add(new Launch() { Name = "বদরপুর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "রাত-১০.৫৫মিনিট" });
