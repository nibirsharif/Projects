...
namespace LaunchServiceBD
{
    public partial class Page21 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map21" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাবুগঞ্জ", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "বিকাল-৬.১৫মিনিট\nরাত-৮.৩০মিনিট\nরাত-৯টা" });
            launchtList.Add(new Launch() { Name = "বাবুগঞ্জ থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৫.৩৫মিনিট\nরাত-১০টা\nদুপুর-১০.৪৫মিনিট" });
