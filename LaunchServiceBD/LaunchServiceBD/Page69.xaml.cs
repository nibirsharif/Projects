...
{
    public partial class Page69 : PhoneApplicationPage
    {
        public Page69()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            //এম ভি টিপু-১
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - ভান্ডারিয়া", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-ভান্ডারিয়া", Fare = "ঢাকা থেকে ছাড়ে সন্ধ্যা ০৭.০০ টা পৌঁছে সকাল ০৯.০০/৯.৩০ টা| ভান্ডারিয়া থেকে  ছাড়ে দুপুর ০২.০০ টা পৌঁছে পরের দিন সকাল ০৭.০০ টা|" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "যে কোন তথ্যের জন্য সদরঘাট লঞ্চ টার্মিনালে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮০১৭১৮-৭৪২২৯৯" });


            launchtList.Add(new Launch() { Name = "ঢাকা - ভান্ডারিয়া", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - ভান্ডারিয়া", Route = "সিংগেল কেবিন - ১০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - ভান্ডারিয়া", Route = "ডাবল কেবিন - ১৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - ভান্ডারিয়া", Route = "ফ্যামিলি কেবিন - ১৮০০/-", Fare = "" });
