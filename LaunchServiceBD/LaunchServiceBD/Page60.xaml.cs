...
{
    public partial class Page60 : PhoneApplicationPage
    {
        public Page60()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা - বরিশাল", Fare = "রাত ৮:৪৫ মিনিটে ঢাকার সদরঘাট থেকে লঞ্চটি বরিশালের উদ্দেশ্যে ছেড়ে যায়। ভোর ০৪.০০ টা থেকে ভোর ০৫.০০ টার মধ্যে বরিশাল পৌঁছে যায়। বরিশাল থেকে একই সময়ে (রাত ৮:৪৫) সদরঘাটের উদ্দেশ্যে ছেড়ে আসে এবং ভোর ০৪.০০ টা থেকে ভোর ০৫.০০ টার মধ্যে ঢাকা পৌঁছে।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "যে কোন তথ্যের জন্য সদরঘাট অফিসে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮০১৭১১-২৭৬৫৯৭  এবং ০১৭১৭-৩৪৪৭৪৭  ,০১৭১১-৩৪৪৭৪৫।" });


            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "সিংগেল কেবিন - ৮৫০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ডাবল কেবিন - ১৬০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ফ্যামিলি কেবিন - ১৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভিআইপি কেবিন - ৪০০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ডিলাক্স - ১২০০/-", Fare = "" });
