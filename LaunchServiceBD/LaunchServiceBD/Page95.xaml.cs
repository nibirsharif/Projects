...
{
    public partial class Page95 : PhoneApplicationPage
    {
        public Page95()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা ০৭.৪৫ টা ।মাদারীপুর থেকে ঢাকার উদ্দেশ্যে ছাড়ে দুপুর ০২.০০ টা" , Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = " যোগাযোগের ফোন নম্বর: +৮৮-০১৭১৬-২১৭২৭৬" });

            launchtList.Add(new Launch() { Name = "ঢাকা - মাদারীপুর", Route = "ডাবল কেবিন - ৮০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - মাদারীপুর", Route = "সিঙ্গেল কেবিন - ৫০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - মাদারীপুর", Route = "ডেক - ১৬০/- টাকা", Fare = "" });
