...
{
    public partial class Page82 : PhoneApplicationPage
    {
        public Page82()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - বোরহানউদ্দিন", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকার সদরঘাট টার্মিনাল থেকে সন্ধ্যা ০৭.৩০ টা মিনিটে ভোলার বোরহানউদ্দিনের উদ্দেশ্যে ছেড়ে যায়।বোরহানউদ্দিন পৌঁছে সকাল ০৬.০০/৬.৩০ টা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "বোরহানউদ্দিন থেকে ছাড়ে বিকাল ০৪.০০ টা।ঢাকা পৌঁছে  সকাল ০৬.০০/৬.৩০ টা", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "ঢাকা সদরঘাট লঞ্চ টার্মিনালে গিয়ে সরাসরি যোগাযোগ করা যায়।", Fare = "মোবাইল:০১৭১২১০৮৯৯২" });

            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "ডাবল কেবিন - ১৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "সিঙ্গেল কেবিন - ৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "ডেক - ২০০/-", Fare = "" });
