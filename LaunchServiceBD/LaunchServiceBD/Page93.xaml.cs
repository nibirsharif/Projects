...
{
    public partial class Page93 : PhoneApplicationPage
    {
        public Page93()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - লেতড়া ", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা ০৬.৩০ টা লেতড়া  পৌঁছে দুপুর ১২.০০ টা।লেতড়া   থেকে ঢাকার উদ্দেশ্যে ছাড়ে সকাল ১০.০০ টা ঢাকা পৌঁছে  সকাল ০৭.০০ টা", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = " যোগাযোগের  ফোন নম্বর: +৮৮-০১৭৩৯৪১৬৬৪৮" });

            launchtList.Add(new Launch() { Name = "ঢাকা - লেতড়া", Route = "ডাবল কেবিন - ১০০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - লেতড়া", Route = "সিঙ্গেল কেবিন - ৬০০/-টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - লেতড়া", Route = "ডেক - ২০০/- টাকা", Fare = "" });
