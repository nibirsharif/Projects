...
namespace LaunchServiceBD
{
    public partial class Page14 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map14" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চাঁন্দপুর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-২টা" });
            launchtList.Add(new Launch() { Name = "চাঁন্দপুর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সকাল-৮টা" });
