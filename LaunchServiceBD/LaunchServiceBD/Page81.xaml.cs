...
{
    public partial class Page81 : PhoneApplicationPage
    {
        public Page81()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকার সদরঘাট টার্মিনাল থেকে সন্ধ্যা ৭.০০ মিনিটে ভোলার বোরহানউদ্দিনের উদ্দেশ্যে ছেড়ে যায়।", Fare = "" });
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "ডাবল কেবিন - ১,৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "সিঙ্গেল কেবিন - ৯০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – বোরহানউদ্দিন", Route = "ডেক - ২২৫/-", Fare = "" });
