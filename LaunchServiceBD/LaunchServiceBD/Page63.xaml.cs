...
{
    public partial class Page63 : PhoneApplicationPage
    {
        public Page63()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-বরিশাল", Fare = "রাত ০৮:৩০ মিনিটে ঢাকার সদরঘাট থেকে লঞ্চটি বরিশালের উদ্দেশ্যে ছেড়ে যায়। ভোর ০৪.০০ টায় বরিশাল পৌঁছে যায়। বরিশাল থেকে একই সময়ে (রাত ০৮:৩০) সদরঘাটের উদ্দেশ্যে ছেড়ে আসে এবং ভোর ০৪.০০ টায় ঢাকা পৌঁছে ।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট অফিস বা বরিশাল অফিসে যোগাযোগ করা যেতে পারে যেকোন তথ্যের জন্য।", Fare = "ফোন নম্বর: +৮৮০১৭১১-৩২৪৬২৯।  " });
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা - বরিশাল", Route = "ভিআইপি কেবিন - ৫০০০/-", Fare = "" });
