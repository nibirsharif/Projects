...
namespace LaunchServiceBD
{
    public partial class Page11 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map11" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চৌধুরীহাট", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "ভোর-৬টা" });
            launchtList.Add(new Launch() { Name = "চৌধুরীহাট থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সন্ধ্যা-৭.১৫মিনিট" });
