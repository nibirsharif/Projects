...
{
    public partial class Page88 : PhoneApplicationPage
    {
        public Page88()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - কালাইয়া, কুয়াকাটা ", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা থেকে ছাড়ে সন্ধ্যা ৭:০০ টা কালাইয়া পৌঁছে সকাল ০৬.০০/৭.০০ টা।", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮-০১১৯০৩৭৯১৪৬" });

            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "ডাবল কেবিন - ১০০০/- টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "সিঙ্গেল কেবিন - ১৬০০/- টাকা", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – কালাইয়া", Route = "ডেক - ২০০/- টাকা", Fare = "" });
