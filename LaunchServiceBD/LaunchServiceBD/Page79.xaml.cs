...
{
    public partial class Page79 : PhoneApplicationPage
    {
        public Page79()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – ভোলা", Fare = "এই লঞ্চটি ঢাকার সদরঘাট টার্মিনাল থেকে রাত ৮.০০ মিনিটে ভোলার উদ্দেশ্যে ছেড়ে যায়।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "ঢাকার সদরঘাট লঞ্চ টার্মিনালে গিয়ে সরাসরি অথবা মোবাইলে যোগাযোগ করা যায়।", Fare = "মোবাইল:+৮৮-০১৭১২-০২৬৮০৮" });


            launchtList.Add(new Launch() { Name = "ঢাকা – ভোলা", Route = "ডাবল কেবিন - ১২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ভোলা", Route = "সিঙ্গেল কেবিন - ৭০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – ভোলা", Route = "ডেক - ২০০/-", Fare = "" });
