...
{
    public partial class Page61 : PhoneApplicationPage
    {
        public Page61()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-বরিশাল", Fare = "এই লঞ্চটি ঢাকার সদরঘাট টার্মিনাল থেকে রাত ৮.৩০ মিনিটে বরিশালের উদ্দেশ্যে ছেড়ে যায়।" });
