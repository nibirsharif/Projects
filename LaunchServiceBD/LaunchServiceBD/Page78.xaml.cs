...
{
    public partial class Page78 : PhoneApplicationPage
    {
        public Page78()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – হাতিয়া", Fare = "ঢাকা থেকে ছাড়ে বিকাল ৫.৩০ টা পৌঁছে সকাল ৯.৩০ টা| হাতিয়া থেকে  ছাড়ে দুপুর ১২ টা পৌঁছে পরের দিন ভোর ৫.৩০-৬ টা|" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে সরাসরি যোগাযোগ করা যায়।", Fare = "মোবাইল: ০১৭১১৩৪৯২৫৭" });


            launchtList.Add(new Launch() { Name = "ঢাকা – হাতিয়া", Route = "ভিআইপি - ২,৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – হাতিয়া", Route = "ডাবল কেবিন - ১,৫০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – হাতিয়া", Route = "সিঙ্গেল কেবিন - ৮০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – হাতিয়া", Route = "৩য় শ্রেণী (ডেক) - ২২০/-", Fare = "" });
