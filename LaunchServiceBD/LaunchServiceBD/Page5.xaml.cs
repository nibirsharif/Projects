...
namespace LaunchServiceBD
{
    public partial class Page5 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map5" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে চন্দনপুর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-১১.৩০মিনিট\nরাত-১২টা" });
            launchtList.Add(new Launch() { Name = "চন্দনপুর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "রাত-১২.২৫মিনিট\nরাত-১.২৫মিনিট\nরাত-১.৪৫মিনিট" });
