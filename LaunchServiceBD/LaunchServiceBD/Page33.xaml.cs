...
namespace LaunchServiceBD
{
    public partial class Page33 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map33" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে আনন্দবাজার", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-১২টা\nরাত-১১.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "আনন্দবাজার থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "সকাল-৯.২৫মিনিট" });
            return launchtList;
        }
