...
namespace LaunchServiceBD
{
    public partial class Page36 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map36" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে আন্ডারচর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "সন্ধ্যা-৬টা\nরাত-৭.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "আন্ডারচর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৫.৪০মিনিট\nবিকাল-৫.৪৫মিনিট" });
