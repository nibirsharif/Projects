...
{
    public partial class Page84 : PhoneApplicationPage
    {
        public Page84()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "রুট", Route = "ঢাকা - দুবলারচর।", Fare = "" });

            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = " ঢাকার সদরঘাট টার্মিনাল থেকে দুপুর ১.০০ মিনিটে দুবলারচরের উদ্দেশ্যে ছেড়ে যায়।", Fare = "" });

            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট লঞ্চ টার্মিনালে গিয়ে অথবা মোবাইলের মাধ্যমে যে কোন তথ্যর জন্য যোগাযোগ করা যায়।", Fare = "মোবাইল:+৮৮-০১৯১৪-৮৭২১৩৩" });

            launchtList.Add(new Launch() { Name = "ঢাকা – দুবলারচর", Route = "ডাবল কেবিন - ৬০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – দুবলারচর", Route = "সিঙ্গেল কেবিন - ৩০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা – দুবলারচর", Route = "ডেক - ৯০/-", Fare = "" });
