...
{
    public partial class Page43 : PhoneApplicationPage
    {
        public Page43()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map43" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বাগমারা", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-৭.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বাগমারা থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "বিকাল-৪.৪৫মিনিট" });
