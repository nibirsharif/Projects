...
{
    public partial class Page76 : PhoneApplicationPage
    {
        public Page76()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা – লালমোহন", Fare = "এই লঞ্চটি ঢাকার সদরঘাট টার্মিনাল থেকে সন্ধ্যা ৬.০০ টায় লালমোহনের উদ্দেশ্যে ছেড়ে যায়।" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "ঢাকা সদরঘাট বা বরিশাল লঞ্চ টার্মিনালে গিয়ে যোগাযোগ করা যায়।", Fare = "মোবাইল: ০১৭১১-৯০৭২২০" });


            launchtList.Add(new Launch() { Name = "ঢাকা – লালমোহন", Route = "ডাবল কেবিন - ১,৬০০/-", Fare = "" });
