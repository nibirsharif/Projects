...
{
    public partial class Page42 : PhoneApplicationPage
    {
        public Page42()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map42" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বালিয়াতলী", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "দুপুর-২.৩০মিনিট\nরাত-৭.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "বালিয়াতলী থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-২.২৫মিনিট\nবিকাল-৫টা" });
