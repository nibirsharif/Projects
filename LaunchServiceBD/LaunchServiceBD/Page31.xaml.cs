...
namespace LaunchServiceBD
{
    public partial class Page31 : PhoneApplicationPage
    {
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map31" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে আওলিয়াপুর", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "সন্ধ্যা-৭টা\nরাত-৮টা\nরাত-৯.৩০মিনিট" });
            launchtList.Add(new Launch() { Name = "আওলিয়াপুর থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-২.১৫মিনিট\nবিকাল-৩.১৫মিনিট" });
