...
{
    public partial class Page64 : PhoneApplicationPage
    {
        public Page64()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ছাড়ার স্থান ও সময়সূচী", Route = "ঢাকা-ভাষানচর", Fare = "ঢাকা থেকে ছাড়ে রাত ০৯.৩০ টা পৌঁছে সকাল ০৮.০০ টা| ভাষানচর থেকে ছাড়ে সন্ধ্যা ০৫.৩০ টা পৌঁছে ভোর ০৫.৩০ টা|" });
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট অফিসে যোগাযোগ করা যেতে পারে যেকোন তথ্যের জন্য।", Fare = "ফোন নম্বর: +৮৮-০১৭১১২৭২৫৫০  " });


            launchtList.Add(new Launch() { Name = "ঢাকা - ভাষানচর", Route = "ডেক - ২০০/-", Fare = "" });
            launchtList.Add(new Launch() { Name = "ঢাকা - ভাষানচর", Route = "সিংগেল কেবিন - ৬০০/-", Fare = "" });
