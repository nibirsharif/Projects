...
{
    public partial class Page58 : PhoneApplicationPage
    {
        public Page58()
        {
            InitializeComponent();
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "যোগাযোগ ও অগ্রিম বুকিং", Route = "সদরঘাট অফিসে যোগাযোগ করা যায়।", Fare = "ফোন নম্বর: +৮৮০১৭১১-২৭৬৫৯৭  এবং ০১৭১৭-৩৪৪৭৪৭ ।" });
