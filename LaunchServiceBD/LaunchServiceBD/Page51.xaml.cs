...
{
    public partial class Page51 : PhoneApplicationPage
    {
        public Page51()
        {
            InitializeComponent();
        ...
        private static IEnumerable<MainMenu> GetMenuList()
        {
            ...
            menuList.Add(new MainMenu() { Name = "ম্যাপ", PageName = "Map51" });
        ...
        private static IEnumerable<Launch> GetLaunchList()
        {
            ...
            launchtList.Add(new Launch() { Name = "ঢাকা থেকে বোদারবাজার", Route = "ঢাকা থেকে গন্তব্যে ছাড়ার সময়", Fare = "রাত-১০৩০মিনিট\nরাত-১১.৩০মিনিট\nত-১২টা" });
            launchtList.Add(new Launch() { Name = "বোদারবাজার থেকে সদরঘাট, ঢাকা", Route = "গন্তব্য থেকে ঢাকায় ফেরার সময়", Fare = "দুপুর-১.০৫মিনিট\nরাত-১.২৫মিনিট\nদুপুর-২.০৫মিনিট" });
            return launchtList;
        }
